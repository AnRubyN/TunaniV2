...
const ComponentePagoTarjeta = () => {
  ...
  const [showForm, setShowForm] = useState(false);  // Controlar si mostrar el formulario
      ...
      <div className="contenedor-cuadros" style={{ display: 'flex', alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 2 }}>
          ...
          <div className='cuadro1' style={{ width: '100%', border: '1px solid black', padding: '10px' }}>
            ...
            <button className='botonSelect' onClick={abrirModal}>Seleccionar/Editar</button>
              ...
              <div className="modal">
                <div className="modal-content">
                  ...
                  <form onSubmit={handleFormSubmit}>
                    ...
                    <button className="boton-guardar-direccion" type="submit">Guardar Dirección</button>
                  </form>
                </div>
              </div>
            )}
        ...
        <div style={{ flex: 1, marginLeft: '500px' }}>
          ...
          <div>
            <div className="cuadro3" style={{ width: '150%', height: '15rem', border: '1px solid black', padding: '20px' , marginTop: '-54.9rem'}}>
