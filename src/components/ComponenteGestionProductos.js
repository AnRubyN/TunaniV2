...
const handleSort = (field) => {
  ...
  const filteredAndSortedProductos = productos
    ...
    return (
        <div className='gestion-artesanias-contenedor'>
            ...
            <div className='titulo-agregar-contenedor'>
            <h2>Lista de Productos</h2>
            <button>🞣 Agregar Artesanias</button>
            </div>
  ...
  <tbody>
    {filteredAndSortedProductos.map((producto) => (
      <tr key={producto.id}>
        ...
        <td>
          <button id="boton-editar" onClick={() => seleccionarParaEditar(producto)}>✎ Editar</button>
